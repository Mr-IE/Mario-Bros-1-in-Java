 ...
 * 0-1104       1136-1376   1424-2448   2480-3384
 * 
 ...
 */    
    ...
    public boolean play() {
        ...
        if (player.getX() > tilesize*25 && pixelPosition < 2530) {
            player.scroll();
            for(int i = 0; i < myNonMovables.size(); i++) myNonMovables.get(i).scroll();
            for(int i = 0; i < myMovables.size(); i++) myMovables.get(i).scroll();
                
            
            pixelPosition+=2;
            
        }
        if (player.getX() > 734) results = false;
